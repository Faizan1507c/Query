...
-- Description: Flexible report for custom date range with ARYCoin, MG, SaveGold
-- =============================================
...
-- ========== MAIN PURCHASE REPORT (Full Detail) ==========
SELECT  
    pur.TRXNID, pur.CardStatus, pur.ProfileID_FK AS CustomerID, pur.Name AS CustomerName,
    pur.CustomerRegistrationDate, pur.City, pur.Amount, pur.GoldRate,
    pur.InsertedDateTime AS PurchaseDateTime, pur.VenderName, pur.TransactionID,
    pur.BranchName, pur.ProductName, pur.TransactionStatus,
...
ORDER BY pur.ProfileID_FK, pur.InsertedDateTime
